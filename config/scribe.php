...
return [
    ...
    'title' => 'AI IDEs API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Documentation for the public API of AI IDEs and their versions',
    ...
    'base_url' => env('API_BASE_URL', 'https://api.aicodingdaily.com/ide-versions'),
